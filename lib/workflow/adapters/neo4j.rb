  ...
  module Adapter
    module Neo4j
      def self.included(klass)
        klass.send :include, Adapter::Neo4j::InstanceMethods
        klass.send :extend, Adapter::Neo4j::Scopes
      ...
      # This module will automatically generate Neo4j scopes based on workflow states.
      # The name of each generated scope will be something like `with_<state_name>_state`
      #
      # Examples:
      #
      # Article.with_pending_state # => Neo4j::Relation
      #
